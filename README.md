...
flowchart TD
    ...
    E["**ActionGate** · Layer 4\nFinal go/no-go integrating all signals"]
    E --> F["ALLOWED"]
    E --> G["NEEDS_APPROVAL"]
    E --> Z
```

**Layer 1 (RuleGate)** is fully implemented. Layers 2-4 ship as protocol interfaces with passthrough stubs — plug in your own implementations as needed.
...
async def before_tool_hook(tool_name: str, args: dict) -> bool:
